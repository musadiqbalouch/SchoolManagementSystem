...
const Dataheader = ({ title }) => {
  return (
    ...
    >
      <h2 className="w-35  laptop:w-30  laptop-lg:w-34 desktop:w-40">Name</h2>
      <h2 className="w-35 laptop:w-20 laptop-lg:w-30 desktop:w-30">{title}</h2>
      <h2 className="w-70 laptop:w-48  laptop-lg:w-80 desktop:w-80">
        Email address
      </h2>
