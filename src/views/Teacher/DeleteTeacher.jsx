...
const DeleteTeacher = ({ setConfirmDelete, confirmDelete }) => {
  return (
    <div className=" bg-white h-35 py-5 px-5 flex flex-col  rounded-lg gap-2">
      ...
      <button
        className=" cursor-pointer px-4 py2  rounded-md font-semibold text-white  border border-gray-400  bg-blue-600 hover:bg-blue-700"
