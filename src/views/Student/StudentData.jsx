...
const StudentData = ({ studentData, setStudentData }) => {
  ...
  return (
    <div className="p-2 container m-auto flex flex-col gap-3">
      {/* Header Row */}
      <div
        className="flex font-semibold laptop:text-base text-lg  bg-gray-200 py-2 px-12 gap-5 mt-5 m-auto
      shadow-sm border rounded-md laptop:px-2 laptop-lg:text-2xl laptop-lg:px-5 laptop-lg:w-full desktop:text-2xl desktop:px-5 desktop:w-full"
      >
        <h2 className="w-35 laptop:w-30  laptop-lg:w-36 desktop:w-40">Name</h2>
        <h2 className="w-35 laptop:w-25 laptop-lg:w-30 desktop:w-30">
          Student ID
        </h2>
        <h2 className="w-70 laptop:w-50 laptop-lg:w-80 desktop:w-80">
          Email address
        </h2>
        <h2 className="w-35 laptop:w-25 laptop-lg:w-28 desktop:w-30">Class</h2>
        <h2 className="w-20 laptop:w-15 laptop-lg:w-30 desktop:w-30">Gender</h2>
      ...
      <div className=" m-auto">
        ...
        laptop:text-sm laptop:px-2 laptop-lg:text-xl laptop-lg:px-4 desktop:text-xl desktop:px-5"
          >
