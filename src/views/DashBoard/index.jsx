...
const DashboardPage = () => {
  ...
  return (
    <div className="flex flex-col items-center content-center relative container m-auto">
      <div className="h-30 bgpurple-500 text-[#4F4F4F] font-semibold px-45 flex flex-col gap-3 mt-5 py-5 text-center laptop:text-left">
        <h1 className="text-3xl">Welcome to your dashboard, Udemy school</h1>
        <h3 className="text-2xl laptop:mx-15">Uyo/school/@teachable.com</h3>
      </div>
      {items.map((item, index) => (
        <div
          key={index}
          className="flex flex-col laptop:flex-row items-center laptop:items-start w-fit py-2 px-5 bgamber-400 gap-4 text-[#4F4F4F] mt-5 text-center laptop:text-left"
        >
