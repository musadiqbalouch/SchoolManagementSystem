    ...
    <div className="bg-[#FCFAFA] w-full ">
      <div className="flex flex-col laptop:flex-row h-auto laptop:h-25 items-center laptop:items-end px-5 container m-auto desktop:h-30">
        <div className="flex flex-col laptop:flex-row items-center laptop:items-end mb-5 laptop:mb-4 px-3 w-full">
          <p className="text-base font-semibold px-10 laptop:px-6  laptop:w-143  text-center laptop:text-left laptop-lg:text-xl laptop-lg:w-180  desktop:text-xl desktop:w-180  ">
          ...
          <Link
            ...
            className="bg-[#509CDB] h-8 text-center px-5 rounded-xl mt-3 laptop:mt-0 laptop:h-8  laptop:text-base  cursor-pointer py-1 font-medium
             laptop-lg:text-xl laptop-lg:py-0  desktop:h-10 desktop:w-30 text-xl desktop:ml-5"
