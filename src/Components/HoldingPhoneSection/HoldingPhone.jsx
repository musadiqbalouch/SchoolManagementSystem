...
const HoldingPhone = () => {
  return (
    <div
      className="flex flex-row w-full p-10 items-center justify-center m-auto content-center gap-40 mt-5  laptop:p-6 laptop:gap-20 laptop:mt-3 
                 laptop-lg:p-8 laptop-lg:gap-28 laptop-lg:mt-5
                 tablet:p-4 tablet:gap-10 tablet:mt-2 
                 desktop:p-14 desktop:gap-48 desktop:mt-8"
    >
      <div
        className="w-100 flex flex-col gap-7 p-5  laptop:gap-5 laptop:p-3 laptop:w-110 laptop:ml-15 laptop-lg:gap-6 laptop-lg:p-5 laptop-lg:w-185 laptoplg:bg-amber-400 laptop-lg:ml-30
      ...
      >
        ...
        <p
          className="text-sm text-[#667085] leading-tight laptop:text-xs laptop:leading-5  laptop-lg:text-base laptop-lg:leading-6
        ...
        <div className="flex gap-4 items-center  laptop:gap-3  laptop-lg:gap-4 tablet:gap-2 desktop:gap-6">
          <IoIosContact
            className="text-[#667085] h-10 w-10 
                       laptop:h-8 laptop:w-8 
                       laptop-lg:h-10 laptop-lg:w-10 
                       tablet:h-6 tablet:w-6 
                       desktop:h-14 desktop:w-14"
          />
          <div className=" laptop-lg:mt-5 ">
            <h2
              className="text-2xl font-semibold 
                         laptop:text-xl 
                         laptop-lg:text-3xl
            ...
            <p
              className="text-[#667085] text-sm leading-tight 
                         ...
                         laptop-lg:text-base laptop-lg:leading-5
                         tablet:text-[11px] tablet:leading-4 
      ...
      <div className="w-2/4 flex justify-center">
        <img
          className="h-125 w-105 object-cover 
                     ...
                     laptop-lg:h-[420px] laptop-lg:w-[340px]
